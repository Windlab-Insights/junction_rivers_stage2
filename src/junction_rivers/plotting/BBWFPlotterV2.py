...
class BBWFPlotter(Plotter):
    ...
    def plot_from_df_and_dict(
        ...
        # ax_oltc = fig.add_subplot(column_other[4+n:5+n, -1])
        # ax_tap_pos = fig.add_subplot(column_other[5+n, -1])
        ...
        self.signal_plot(
            ax=ax_poc[0],
            title='POC: P [MW]',
            traces=[('Pref', LW_REF, COL_REF, 1, pref_mw),
        ...
        self.signal_plot(
            ax=ax_poc[1],
            title='POC: Q [MVAr]',
            traces=[('Qref Droop', LW_REF, COL_REF, 1, qref_mvar),
        ...
        #     poc_vrms_a = df['POC_PhaseA_V_pu'][self.plot_start:self.plot_end][::DECIMATE]
        #     poc_vrms_b = df['POC_PhaseB_V_pu'][self.plot_start:self.plot_end][::DECIMATE]
        #     poc_vrms_c = df['POC_PhaseC_V_pu'][self.plot_start:self.plot_end][::DECIMATE]
        ...
        for i in range(1,NUM_WTG+1):
            traces.append(("", LW_NORM, COL_LVRT, i, df[f'WTG_LVRT_Flag:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
            traces.append(("", LW_NORM, COL_HVRT, i, df[f'WTG_HVRT_Flag:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
            traces.append(("", LW_NORM, COL_TRIP, i, df[f'WTG_Trip_Flag:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        for i in range(1,NUM_BESS+1):
            traces.append(("", LW_NORM, COL_LVRT, i, df[f'BESS_LVRT_Flag:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
            traces.append(("", LW_NORM, COL_HVRT, i, df[f'BESS_HVRT_Flag:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
            traces.append(("", LW_NORM, COL_TRIP, i, df[f'BESS_Trip_Flag:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        # WTG P Plotting
        wtg_p_traces=[]
        wtg_p_traces.append(('Pref', LW_REF, COL_REF, 20, df['WTG_Unit_Pref_MW:1:1'][self.plot_start:self.plot_end][::DECIMATE]),)
        for i in range(1,NUM_WTG+1):
            wtg_p_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'WTG_Terminal_P_MW:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        # WTG Q Plotting
        wtg_q_traces=[]
        # wtg_q_traces.append(('Qref', LW_REF, COL_REF, 20, df['WTG_Unit_Qset_MVAr:1:1'][self.plot_start:self.plot_end][::DECIMATE]),)
        for i in range(1,NUM_WTG+1):
            wtg_q_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'WTG_Terminal_Q_MVAr:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        # WTG V Plotting
        wtg_v_traces=[]
        wtg_v_traces.append(('Vref', LW_REF, COL_REF, 20, df['WTG_Vset_pu:1:1'][self.plot_start:self.plot_end][::DECIMATE]),)
        for i in range(1,NUM_WTG+1):
            wtg_v_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'WTG_Terminal_V_pu:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        #     traces_a = [('W1', LW_NORM, COL_SIG_2, 4, df['WT1_Va_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]),
        #                 ('W2', LW_NORM, COL_SIG_2, 3, df['WT2_Va_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]),
        #                 ('W3', LW_NORM, COL_SIG_3, 2, df['WT3_Va_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]),
        #                 ('W4', LW_NORM, COL_SIG_4, 1, df['WT4_Va_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]), ]

        #     traces_b = [('W1', LW_NORM, COL_SIG_2, 4, df['WT1_Vb_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]),
        #                 ('W2', LW_NORM, COL_SIG_2, 3, df['WT2_Vb_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]),
        #                 ('W3', LW_NORM, COL_SIG_3, 2, df['WT3_Vb_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]),
        #                 ('W4', LW_NORM, COL_SIG_4, 1, df['WT4_Vb_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]), ]

        #     traces_c = [('W1', LW_NORM, COL_SIG_2, 4, df['WT1_Vc_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]),
        #                 ('W2', LW_NORM, COL_SIG_2, 3, df['WT2_Vc_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]),
        #                 ('W3', LW_NORM, COL_SIG_3, 2, df['WT3_Vc_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]),
        #                 ('W4', LW_NORM, COL_SIG_4, 1, df['WT4_Vc_rms_pu'][self.plot_start:self.plot_end][::DECIMATE]), ]
        ...
        wtg_id_traces=[]
        for i in range(1,NUM_WTG+1):
            wtg_id_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'WTG_Id_pu:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        wtg_iq_traces=[]
        for i in range(1,NUM_WTG+1):
            wtg_iq_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'WTG_Iq_pu:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        wtg_angle_traces=[]
        for i in range(1,NUM_BESS+1):
            wtg_angle_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'WTG_Angle_deg:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ax_wtg[-1].plot([], [], c=COL_SIG_2, label=f"WTG1-{NUM_WTG}")
        self.signal_plot(
            ax=ax_wtg[-1],
            title='WTG: Angle [deg]',
        ...
        # BESS P Plotting
        bess_p_traces=[]
        bess_p_traces.append(('Pref', LW_REF, COL_REF, 20, df['BESS_Unit_Pref_MW:1:1'][self.plot_start:self.plot_end][::DECIMATE]),)
        for i in range(1,NUM_BESS+1):
            bess_p_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'BESS_Terminal_P_MW:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        # BESS Q Plotting
        bess_q_traces=[]
        bess_q_traces.append(('Qref', LW_REF, COL_REF, 20, df['BESS_Unit_Qset_MVAr:1:1'][self.plot_start:self.plot_end][::DECIMATE]),)
        for i in range(1,NUM_BESS+1):
            bess_q_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'BESS_Terminal_Q_MVAr:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        # BESS V Plotting
        bess_v_traces=[]
        bess_v_traces.append(('Vref', LW_REF, COL_REF, 20, df['BESS_Vset_pu:1:1'][self.plot_start:self.plot_end][::DECIMATE]),)
        for i in range(1,NUM_BESS+1):
            bess_v_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'BESS_Terminal_V_pu:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        bess_id_traces=[]
        for i in range(1,NUM_BESS+1):
            bess_id_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'BESS_Id_pu:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        bess_iq_traces=[]
        for i in range(1,NUM_BESS+1):
            bess_iq_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'BESS_Iq_pu:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ...
        bess_angle_traces=[]
        for i in range(1,NUM_BESS+1):
            bess_angle_traces.append(("", LW_NORM, COL_SIG_2, i, df[f'BESS_Angle_deg:1:{i}'][self.plot_start:self.plot_end][::DECIMATE]))
        ax_bess[-1].plot([], [], c=COL_SIG_2, label=f"BESS1-{NUM_BESS}")
        self.signal_plot(
            ax=ax_bess[-1],
